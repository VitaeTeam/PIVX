...
std::vector<CSporkDef> sporkDefs = {
    ...
    MAKE_SPORK_DEF(SPORK_7_FUNDAMENTALNODE_PAYMENT_ENFORCEMENT,  4070908800ULL), // OFF
    MAKE_SPORK_DEF(SPORK_8_FUNDAMENTALNODE_BUDGET_ENFORCEMENT,   4070908800ULL), // OFF
